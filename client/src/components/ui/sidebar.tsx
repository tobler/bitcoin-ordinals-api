    ...
    >
      ...
      <nav className="p-4">
        ...
        <ul className="space-y-2">
          <li>
            <Link href="/">
              <a className={`flex items-center ${isActive('/') ? 'text-white bg-bitcoin-orange' : 'text-white hover:text-black hover:bg-amber-300'} rounded-md px-3 py-2`}>
          ...
          <li>
            <Link href="/docs/quickstart">
              <a className={`flex items-center ${isActive('/docs/quickstart') ? 'text-white bg-bitcoin-orange' : 'text-white hover:text-black hover:bg-amber-300'} rounded-md px-3 py-2`}>
        ...
        <ul className="space-y-2">
          <li>
            <Link href="/create-ordinal">
              <a className={`flex items-center ${isActive('/create-ordinal') ? 'text-white bg-bitcoin-orange' : 'text-white hover:text-black hover:bg-amber-300'} rounded-md px-3 py-2`}>
          ...
          <li>
            <Link href="/create-collection">
              <a className={`flex items-center ${isActive('/create-collection') ? 'text-white bg-bitcoin-orange' : 'text-white hover:text-black hover:bg-amber-300'} rounded-md px-3 py-2`}>
          ...
          <li>
            <Link href="/docs/list-ordinals">
              <a className={`flex items-center ${isActive('/docs/list-ordinals') ? 'text-white bg-bitcoin-orange' : 'text-white hover:text-black hover:bg-amber-300'} rounded-md px-3 py-2`}>
          ...
          <li>
            <Link href="/docs/view-ordinal">
              <a className={`flex items-center ${isActive('/docs/view-ordinal') ? 'text-white bg-bitcoin-orange' : 'text-white hover:text-black hover:bg-amber-300'} rounded-md px-3 py-2`}>
